...
sudo su -c 'rpm -Uhv https://download1.rstudio.org/rstudio-0.97.320-x86_64.rpm'
sudo yum -y install mesa-libGL-devel mesa-libGLU-devel libpng-devel libjpeg-devel
